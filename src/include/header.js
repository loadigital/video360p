...
<header>
    ...
    <div class="menu_bar">
        <div class="bt-menu"><img src="https://www.biloa.store/img/LOGO11.png" alt=""><span class="bi-list" id="menu_bar"></span></div>
     </div>
                ...
                <div class="contenedor_list flexrow-c col-12">
                    ...
                    <li class="btn-- class-web"><a id="btn--" href="#" data="next"><span class="bi-three-dots-vertical"></span>Mas Opciones</a>
                        <ul class="hidden" id="hidden">
                            ...
                            <li class="next"><a target="_blank" href="https://biloa.website/app/descargarApp.html" data="next"><span class="bi-android2"></span>Descargar App</a></li>
                    ...
                    <li class="next class-mo"><a target="_blank" href="https://biloa.website/app/descargarApp.html" data="next"><span class="bi-android2"></span>Descargar App</a></li>
                    <li class="next class-mo"><a target="_blank" href="https://t.me/vid360p" data="next"><span class="bi-telegram"></span>Grupo Telegram</a></li>
                    <li class="next class-mo"><a  href="#" data="next"><span class="bi-gear-fill"></span>Versión 0.1</a></li>
                </div>
